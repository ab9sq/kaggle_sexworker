...
#subset(worker, subset = Number_of_advertisments_posted == "")$Number_of_advertisments_posted <- "0" 
#explore gsub
worker$Number_of_advertisments_posted <- gsub(pattern = "",
                                              replacement = "0",
                                              worker$Number_of_advertisments_posted)
